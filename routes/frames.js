...
router.get('/auto', function (req, res) {
    ...
    var dir = 'D:/test',
        count = 0,
        txt = [[], [], [], [], []];
    [['180', 'A'], ['135', 'B'], ['90', 'C'], ['45', 'D'], ['0', 'E']].forEach(function (item, index) {
        var itemPath = path.join(dir, item[0]);
        fs.readdir(itemPath, function (err, files) {
            ...
            files.forEach(function (fileName, i) {
                fs.createReadStream(path.join(itemPath, fileName)).pipe(new PNG()).on('parsed', function (data) {
                    ...
                    if (--num === 0) {
                        ...
                        pic.pack().pipe(fs.createWriteStream('D:/' + item[1] + '.png'));
                    ...
                    if (--count === 0) {
                        fs.writeFile('D:/test.txt', txt.reduce(function (a, b) {
                            return a.concat(b);
                        }, [8, files.length]).join());
                        res.end();
                    }
